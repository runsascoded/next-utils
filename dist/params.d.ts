...
export declare function stringsParam(init?: string[], delim?: string): Param<string[], Actions<string>>;
export declare function optStringsParam(delim?: string): Param<undefined | string[]>;
